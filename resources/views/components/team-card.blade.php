<div class="card bg-transparent border-0 text-center">
    <div class="card-img">
        ...
        @endif
        @if($member->fb_url !='' || $member->twiter_url !='' || $member->in_url !='')
        <ul class="card-social list-inline">
            @if($member->fb_url !='')
            <li class="list-inline-item"><a class="facebook" target="_blank" href="{{$member->fb_url}}"><i class="fab fa-facebook"></i></a>
            </li>
            @endif
            @if($member->twiter_url !='')
            <li class="list-inline-item"><a class="twitter" target="_blank" href="{{$member->twiter_url}}"><i class="fab fa-twitter"></i></a>
            </li>
            @endif
            @if($member->in_url !='')
